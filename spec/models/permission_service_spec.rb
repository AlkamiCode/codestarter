  ...
  context "as a company admin" do
    ...
    context "visiting the home page" do
      ...
      context "visiting companies/projects" do
        ...
        context "looking at companies/projects#new" do
          let(:action) { "new" }
        ...
        context "looking at companies/projects#create" do
          let(:action) { "create" }
        ...
        context "looking at companies/projects#edit" do
          let(:action) { "edit" }
        ...
        context "looking at companies/projects#update" do
          let(:action) { "update" }
        ...
        context "looking at companies/projects#destroy" do
          let(:action) { "destroy" }
